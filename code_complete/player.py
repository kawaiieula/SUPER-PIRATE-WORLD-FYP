...
class Player(pygame.sprite.Sprite):
    ...
    def update_name_tag(self):
        ...
        self.name_tag = self.name_font.render(self.name, True, (255, 255, 255))
    ...
    def draw(self, surface):
        ...
        # Draw the name tag above the player if enabled
        if self.show_name:
            name_pos = (
                self.rect.centerx - self.name_tag_rect.width // 2,
                self.rect.top - self.name_tag_rect.height - 5
            )
            surface.blit(self.name_tag, name_pos)